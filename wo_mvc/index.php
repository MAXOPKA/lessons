...
class marketing {
	 ...
	 * @param $all_configs
	 * @TODO Вынести в контроллер Использовать наследование
	 */
	...
	/**
	 * @return array|string
	 * @TODO слишком длинный метод. Смешано представление, работа с данными, и код контроллера
	 */
	...
	/**
	 * @TODO код необходимо вынести в отдеьный контроллер
	 */
